...
//                 m-auto max-sm:text-xs text-gray-600'>Transform your content creation with our suite of premium AI tools. Write articles, generate images, and enhance your workflow.</p>
//          </div>
...
import React from "react";
import { useNavigate } from "react-router-dom";
import { assets } from '../assets/assets'; // ✅ FIXED LINE
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex 
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        ...
        <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
         <img src={assets.user_group} alt="" className='h-8' /> <span className='font-mono'>Trusted by 10k+ people</span>
        </div>
    </div>
  );
};
