import { Hash, Sparkles, Edit, Download } from 'lucide-react';
        ...
        <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
          <div className="flex items-center gap-3">
            ...
            {content && (
              <button
                onClick={downloadPdf}
                className="ml-auto flex items-center gap-2 text-xs px-2 py-1 rounded bg-purple-600 text-white hover:bg-purple-700"
...
//   const onSubmitHandler = async (e) => {
//     e.preventDefault();
//     // Logic for generating titles goes here
//     try {
//     setLoading(true)
//     const prompt = `Generate a blog title for the keyword $(input) in the category $(selectedCategory)`
